...
Subject is a numerical identifier for a particular individual.

Activity can take one of six values - LAYING, SITTING, STANDING, WALKING, WALKING_DOWNSTAIRS, WALKING_UPSTAIRS - which describe the activity of an individual.
...
mean(): Average of the mean value for each activity and each subject in the original data set. 
std(): Average of the standard deviation for each activity and each subject in the original data set. 
